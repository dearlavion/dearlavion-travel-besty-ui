...
export const MASTER_DATA_SEED_DATA: MasterDataValue[] = [
  ...
  { id: 'kitCategory-clothing', type: 'kitCategory', value: 'Clothing', order: 1 },
  { id: 'kitCategory-footwear', type: 'kitCategory', value: 'Footwear', order: 2 },
  { id: 'kitCategory-toiletries', type: 'kitCategory', value: 'Toiletries', order: 3 },
  { id: 'kitCategory-beauty-kit', type: 'kitCategory', value: 'Beauty Kit', order: 4 },
  { id: 'kitCategory-tech-pack', type: 'kitCategory', value: 'Tech Pack', order: 5 },
  { id: 'kitCategory-health-safety', type: 'kitCategory', value: 'Health & Safety', order: 6 },
  { id: 'kitCategory-weather-gear', type: 'kitCategory', value: 'Weather Gear', order: 7 },
  { id: 'kitCategory-activity-gear', type: 'kitCategory', value: 'Activity Gear', order: 8 },
  { id: 'kitCategory-comfort', type: 'kitCategory', value: 'Comfort', order: 9 },
  { id: 'kitCategory-food-hydration', type: 'kitCategory', value: 'Food & Hydration', order: 10 },
