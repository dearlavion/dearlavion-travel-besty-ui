...
export const MASTER_DATA_SEED_DATA: MasterDataValue[] = [
  ...
  { id: 'kitCategory-essentials-kit', type: 'kitCategory', value: 'Essentials Kit', order: 0 },
  { id: 'kitCategory-toiletry-kit', type: 'kitCategory', value: 'Toiletry Kit', order: 1 },
  { id: 'kitCategory-beauty-grooming-kit', type: 'kitCategory', value: 'Beauty & Grooming Kit', order: 2 },
  { id: 'kitCategory-health-safety-kit', type: 'kitCategory', value: 'Health & Safety Kit', order: 3 },
  { id: 'kitCategory-comfort-kit', type: 'kitCategory', value: 'Comfort Kit', order: 4 },
  { id: 'kitCategory-tech-kit', type: 'kitCategory', value: 'Tech Kit', order: 5 },
  { id: 'kitCategory-activity-gear-kit', type: 'kitCategory', value: 'Activity Gear Kit', order: 6 },
  { id: 'kitCategory-weather-kit', type: 'kitCategory', value: 'Weather Kit', order: 7 },
  { id: 'kitCategory-laundry-kit', type: 'kitCategory', value: 'Laundry Kit', order: 8 },
  { id: 'kitCategory-kids-baby-kit', type: 'kitCategory', value: 'Kids & Baby Kit', order: 9 },
  { id: 'kitCategory-pet-travel-kit', type: 'kitCategory', value: 'Pet Travel Kit', order: 10 },

  { id: 'productCategory-toiletries', type: 'productCategory', value: 'Toiletries', order: 0 },
  { id: 'productCategory-beauty-grooming', type: 'productCategory', value: 'Beauty & Grooming', order: 1 },
  { id: 'productCategory-clothing', type: 'productCategory', value: 'Clothing', order: 2 },
  { id: 'productCategory-footwear', type: 'productCategory', value: 'Footwear', order: 3 },
  { id: 'productCategory-electronics', type: 'productCategory', value: 'Electronics', order: 4 },
  { id: 'productCategory-health-safety', type: 'productCategory', value: 'Health & Safety', order: 5 },
  { id: 'productCategory-travel-accessories', type: 'productCategory', value: 'Travel Accessories', order: 6 },
  { id: 'productCategory-activity-gear', type: 'productCategory', value: 'Activity Gear', order: 7 },
  { id: 'productCategory-food-hydration', type: 'productCategory', value: 'Food & Hydration', order: 8 },
  { id: 'productCategory-travel-documents', type: 'productCategory', value: 'Travel Documents', order: 9 },
  { id: 'productCategory-kids-baby', type: 'productCategory', value: 'Kids & Baby', order: 10 },
  { id: 'productCategory-pet-travel', type: 'productCategory', value: 'Pet Travel', order: 11 },
  { id: 'productCategory-laundry-care', type: 'productCategory', value: 'Laundry & Care', order: 12 },
