...
export const PRODUCTS: Product[] = [
  ...
  { id: 'fast-charge-cable-set', name: 'Fast-Charge Cable Set', category: 'Electronics', seasons: [], destinations: [], parties: [], popular: true, tested: true, icon: '🔌', active: true, description: 'Durable braided cables, phone + tablet compatible.', kitCategory: 'Electronics' },
  ...
  { id: 'quick-dry-mini-towel', name: 'Quick-Dry Mini Towel', category: 'Comfort', seasons: ['Summer'], destinations: ['Beach'], parties: [], popular: true, tested: true, icon: '🏖️', active: true, description: "Packs small, dries fast, sand won't stick.", kitCategory: 'Essentials' },
  ...
  { id: 'waterproof-phone-pouch', name: 'Waterproof Phone Pouch', category: 'Electronics', seasons: ['Summer'], destinations: ['Beach'], parties: [], popular: false, tested: true, icon: '📱', active: true, description: 'Keeps your phone dry and usable in the water.', kitCategory: 'Electronics' },
  ...
  { id: 'slim-power-bank-10000mah', name: 'Slim Power Bank 10000mAh', category: 'Electronics', seasons: [], destinations: ['City'], parties: [], popular: true, tested: true, icon: '🔋', active: true, description: 'A full charge for a long day of exploring.', kitCategory: 'Electronics' },
  { id: 'offline-city-map-pack', name: 'Offline City Map Pack', category: 'Electronics', seasons: [], destinations: ['City'], parties: [], popular: false, tested: true, icon: '🗺️', active: true, description: 'Pre-downloaded maps, no data needed.', kitCategory: 'Electronics' },
  { id: 'foldable-laundry-bag', name: 'Foldable Laundry Bag', category: 'Comfort', seasons: [], destinations: ['City'], parties: [], popular: false, tested: true, icon: '🧺', active: true, description: 'Keeps worn clothes separate, packs flat.', kitCategory: 'Essentials' },
  ...
  { id: 'polarized-sunglasses', name: 'Polarized Sunglasses', category: 'Accessories', seasons: ['Summer'], destinations: [], parties: [], popular: true, tested: true, icon: '🕶️', active: true, description: 'UV protection with a lightweight frame.', kitCategory: 'Accessories' },
  { id: 'packable-wide-brim-hat', name: 'Packable Wide-Brim Hat', category: 'Accessories', seasons: ['Summer'], destinations: [], parties: [], popular: false, tested: true, icon: '👒', active: true, description: 'Folds flat, springs back into shape.', kitCategory: 'Accessories' },
  ...
  { id: 'cooling-neck-towel', name: 'Cooling Neck Towel', category: 'Comfort', seasons: ['Summer'], destinations: [], parties: [], popular: false, tested: true, icon: '🧣', active: true, description: 'Activates with water, stays cool for hours.', kitCategory: 'Accessories' },
  ...
  { id: 'insulated-touch-gloves', name: 'Insulated Touch Gloves', category: 'Accessories', seasons: ['Winter'], destinations: [], parties: [], popular: false, tested: true, icon: '🧤', active: true, description: 'Stay warm without taking them off for your phone.', kitCategory: 'Accessories' },
  { id: 'ribbed-wool-beanie', name: 'Ribbed Wool Beanie', category: 'Accessories', seasons: ['Winter'], destinations: [], parties: [], popular: false, tested: true, icon: '🧢', active: true, description: 'Soft merino wool, packs into a pocket.', kitCategory: 'Accessories' },
  { id: 'lip-skin-balm-duo', name: 'Lip & Skin Balm Duo', category: 'Toiletries', seasons: ['Winter'], destinations: [], parties: [], popular: false, tested: true, icon: '💄', active: true, description: 'Protects against wind and dry cabin air.', kitCategory: 'Beauty' },
  ...
  { id: 'packable-rain-jacket', name: 'Packable Rain Jacket', category: 'Clothing', seasons: ['Rainy'], destinations: [], parties: [], popular: true, tested: true, icon: '🧥', active: true, description: 'Waterproof shell that folds into its own pocket.', kitCategory: 'Accessories' },
  { id: 'compact-travel-umbrella', name: 'Compact Travel Umbrella', category: 'Gear', seasons: ['Rainy'], destinations: [], parties: [], popular: true, tested: true, icon: '☂️', active: true, description: 'Windproof frame, fits in a daypack pocket.', kitCategory: 'Accessories' },
  { id: 'waterproof-shoe-covers', name: 'Waterproof Shoe Covers', category: 'Gear', seasons: ['Rainy'], destinations: [], parties: [], popular: false, tested: true, icon: '👢', active: true, description: 'Slip over any shoe to keep feet dry.', kitCategory: 'Accessories' },
  { id: 'electronics-dry-bag', name: 'Electronics Dry Bag', category: 'Electronics', seasons: ['Rainy'], destinations: [], parties: [], popular: false, tested: true, icon: '💧', active: true, description: 'Roll-top seal keeps devices safe from rain.', kitCategory: 'Electronics' },
  ...
  { id: 'travel-esim-card', name: 'Travel eSIM Card', category: 'Electronics', seasons: [], destinations: [], parties: [], popular: true, tested: true, icon: '📶', active: true, description: 'Stay connected the moment you land.', kitCategory: 'Electronics' },
  ...
  { id: 'multi-port-charging-hub', name: 'Multi-Port Charging Hub', category: 'Electronics', seasons: [], destinations: [], parties: [], popular: true, tested: true, icon: '🔌', active: true, description: 'Charge up to 6 devices from one outlet.', kitCategory: 'Electronics' },
  ...
  { id: 'universal-travel-adapter', name: 'Universal Travel Adapter', category: 'Electronics', seasons: [], destinations: [], parties: [], popular: true, tested: true, icon: '🔋', active: true, description: 'Works in 150+ countries, built-in USB ports.', kitCategory: 'Electronics' },

  { id: 'reusable-laundry-bag', name: 'Reusable Laundry Bag', category: 'Comfort', seasons: [], destinations: [], parties: [], popular: false, tested: true, icon: '🧺', active: true, description: 'Mesh bag for longer stays between washes.', kitCategory: 'Essentials' },
  ...
  { id: 'collapsible-silicone-water-bottle', name: 'Collapsible Silicone Water Bottle', category: 'Comfort', seasons: [], destinations: [], parties: [], popular: false, tested: true, icon: '🥤', active: true, description: 'Squashes flat when empty, holds 500ml when full.', kitCategory: 'Essentials' },
  ...
  { id: 'travel-pillow-eye-mask-set', name: 'Travel Pillow & Eye Mask Set', category: 'Comfort', seasons: [], destinations: [], parties: [], popular: false, tested: true, icon: '😴', active: true, description: 'Memory-foam neck pillow paired with a contoured eye mask for real airport sleep.', kitCategory: 'Essentials', transportModes: ['Flight', 'Train'] },
];
